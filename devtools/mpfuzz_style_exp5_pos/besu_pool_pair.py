...
PROFILES = {
    ...
    "layered-1m-firstevict-p24k": dict(pool="LAYERED", capacity=None, layerMaxCapacity=1_000_000,
                                       normalSenders=100, normalRate=800,
                                       normalVictimSenders=3200, recoveryNormalRate=0,
                                       attackSenders=1000, attackRate=8000,
                                       phases=[2, 4, 4, 4, 20], slot=30,
                                       tailPaddingBytes=24576,
                                       chainId=13371389, batchSize=180, runTimeout=21600),
    "layered-1m-firstevict-a2000-p24k": dict(pool="LAYERED", capacity=None, layerMaxCapacity=1_000_000,
                                             normalSenders=100, normalRate=800,
                                             normalVictimSenders=3200, recoveryNormalRate=0,
                                             attackSenders=2000, attackRate=16000,
                                             phases=[2, 4, 4, 4, 20], slot=30,
                                             tailPaddingBytes=24576,
                                             chainId=13371390, batchSize=180, runTimeout=21600),
    "layered-1m-firstevict-p32k": dict(pool="LAYERED", capacity=None, layerMaxCapacity=1_000_000,
                                       normalSenders=100, normalRate=800,
                                       normalVictimSenders=3200, recoveryNormalRate=0,
                                       attackSenders=1000, attackRate=8000,
                                       phases=[2, 4, 4, 4, 20], slot=30,
                                       tailPaddingBytes=32768,
                                       chainId=13371391, batchSize=180, runTimeout=21600),
    # Single-variable comparison with p32k: signing occurs before attack_on;
    # broadcast stays single-worker so the timing effect remains measurable.
    "layered-1m-firstevict-p32k-presign": dict(pool="LAYERED", capacity=None, layerMaxCapacity=1_000_000,
                                               normalSenders=100, normalRate=800,
                                               normalVictimSenders=3200, recoveryNormalRate=0,
                                               attackSenders=1000, attackRate=8000,
                                               phases=[2, 4, 4, 4, 20], slot=30,
                                               tailPaddingBytes=32768, attackPresign=True,
                                               chainId=13371396, batchSize=180, runTimeout=21600),
    "layered-1m-firstevict-p36k": dict(pool="LAYERED", capacity=None, layerMaxCapacity=1_000_000,
                                       normalSenders=100, normalRate=800,
                                       normalVictimSenders=3200, recoveryNormalRate=0,
                                       attackSenders=1000, attackRate=8000,
                                       phases=[2, 4, 4, 4, 20], slot=30,
                                       tailPaddingBytes=36864,
                                       chainId=13371395, batchSize=180, runTimeout=21600),
    "layered-1m-firstevict-p40k": dict(pool="LAYERED", capacity=None, layerMaxCapacity=1_000_000,
                                       normalSenders=100, normalRate=800,
                                       normalVictimSenders=3200, recoveryNormalRate=0,
                                       attackSenders=1000, attackRate=8000,
                                       phases=[2, 4, 4, 4, 20], slot=30,
                                       tailPaddingBytes=40960,
                                       chainId=13371392, batchSize=180, runTimeout=21600),
    ...
    # Keep the successful default-pool p24k workload fixed while reducing the
    # normal-to-attack delay and moving attack signing out of attack_on.
    "default-v5-p24k-burst16": dict(pool="LAYERED", capacity=None, normalSenders=100, normalRate=800,
                                    normalVictimSenders=3200, recoveryNormalRate=0,
                                    attackSenders=8000, attackRate=64000, phases=[2, 4, 4, 4, 20], slot=30,
                                    tailPaddingBytes=24576, normalHelperSendWorkers=32,
                                    attackHelperSendWorkers=16, attackPresign=True,
                                    chainId=13371397, batchSize=120, runTimeout=21600),
    "default-v5-p32k": dict(pool="LAYERED", capacity=None, normalSenders=100, normalRate=800,
                            normalVictimSenders=3200, recoveryNormalRate=0,
                            attackSenders=8000, attackRate=64000, phases=[2, 4, 4, 4, 20], slot=30,
                            tailPaddingBytes=32768, chainId=13371393, batchSize=120, runTimeout=21600),
    "default-v5-p40k": dict(pool="LAYERED", capacity=None, normalSenders=100, normalRate=800,
                            normalVictimSenders=3200, recoveryNormalRate=0,
                            attackSenders=8000, attackRate=64000, phases=[2, 4, 4, 4, 20], slot=30,
                            tailPaddingBytes=40960, chainId=13371394, batchSize=120, runTimeout=21600),
